...
class DictationService:
    ...
    def start_recording(self):
        ...
        self.send_notification("🎙️ Recording", "Speak now...")
    ...
    def process_audio(self):
        ...
        try:
            ...
            self.send_notification("✨ Cleaning", "Polishing your text...")
            ...
            self.send_notification("❌ Error", "Check Terminal for details")
            import traceback
            traceback.print_exc()
